...
let handler = async (_0x3c596a, {
    ...
    let _0x4c11c2 = await (await fetch('https://raw.githubusercontent.com/socona12/TheMystic-Bot-MD/master/src/JSON/Anime-3en.json'))[_0x25a9c0(0x7)]();
    let _0x4ad1ca = _0x4c11c2[Math[_0x25a9c0(0xe)](Math[_0x25a9c0(0x17)]() * _0x4c11c2[_0x25a9c0(0x11)])];
    let _0x37cb43 = ('*' + _0x15e0c9[_0x25a9c0(0x18)]() + _0x25a9c0(0x16) + (timeout / 0x3e8)['toFixed'](0x2) + _0x25a9c0(0x1b) + _0x31d28c + 'استسلم للاستسلام\x0a  الجائزه: ' + poin + _0x25a9c0(0x1))[_0x25a9c0(0x1e)]();
...
function _0x4b4d() {
    const _0x5adff3 = [' XP\x0a『𝐆𝐎𝐍-𝐁𝐎𝐓』\x0a     ', '1326522zrrUIZ', 'name', '9081060EKrvDl', 'command', '21ggFzmZ', 'json', 'tebakbendera', 'reply', '3cpoRiU', '542844GTeBIP', 'في سؤال عشان تبقا عارف', 'guessflag', 'floor', '9BzZBQY', '12820qPGAli', 'length', '4663832lagByn', 'الوقت خلص!\x0aالاجابه هي *', 'game', '908765sOMowA', '*\x0a  المده *', 'random', 'toUpperCase', 'sendFile', '25029840HlpAEC', '* ثانيه\x0a  استخدم ', '285FAvvgx', 'tags', 'trim', 'chat'];
    _0x4b4d = function () {
        return _0x5adff3;
    };
    return _0x4b4d();
